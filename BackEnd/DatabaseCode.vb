...
Public Module DatabaseCode
    ...
    Private Function MakeAmmoTypesTable() As DataTable
        ...
        t.Columns.Add(MakeColumn("red", "Red", GetType(Integer)))
        t.Columns.Add(MakeColumn("green", "Green", GetType(Integer)))
        t.Columns.Add(MakeColumn("blue", "Blue", GetType(Integer)))
        ...
        t.Columns.Add(MakeColumn("usPiercePersonChanceModifier", "Pierce Person Chance Modifier", GetType(Integer)))
        ...
        t.Columns.Add(MakeColumn("dDamageModifierLife", "Damage Modifier", GetType(Decimal), 0))
        t.Columns.Add(MakeColumn("dDamageModifierBreath", "Breath Damage Modifier", GetType(Decimal), 0))
        t.Columns.Add(MakeColumn("dDamageModifierTank", "Tank Damage Modifier", GetType(Decimal), 0))
        t.Columns.Add(MakeColumn("dDamageModifierArmouredVehicle", "Armoured Vehicle Damage Modifier", GetType(Decimal), 0))
        t.Columns.Add(MakeColumn("dDamageModifierCivilianVehicle", "Vehicle Damage Modifier", GetType(Decimal), 0))
        t.Columns.Add(MakeColumn("dDamageModifierZombie", "Zombie Damage Modifier", GetType(Decimal), 0))
        t.Columns.Add(MakeColumn("shotAnimation", "Shot Animation", GetType(String), , , , , , , True))
    ...
    Private Function MakeItemsTable() As DataTable
        ...
        t.Columns.Add(MakeColumn("Alcohol", "Alcohol", GetType(Decimal), , , , , , , True))
        ...
        t.Columns.Add(MakeColumn("RobotDamageReduction", "RobotDamageReduction", GetType(Decimal), , , , , , , True))
        ...
        t.Columns.Add(MakeColumn("RobotAgiBonus", "RobotAgiBonus", GetType(Integer), , , , , , , True))
        t.Columns.Add(MakeColumn("RobotDexBonus", "RobotDexBonus", GetType(Integer), , , , , , , True))
        t.Columns.Add(MakeColumn("RobotTargetingSkillGrant", "RobotTargetingSkillGrant", GetType(Integer), , , , , , , True))
        t.Columns.Add(MakeColumn("RobotUtilitySkillGrant", "RobotUtilitySkillGrant", GetType(Integer), , , , , , , True))
        t.Columns.Add(MakeColumn("RobotChassisSkillGrant", "RobotChassisSkillGrant", GetType(Integer), , , , , , , True))
        t.Columns.Add(MakeColumn("TransportGroupMinProgress", "TransportGroupMinProgress", GetType(Integer), , , , , , , True))
        t.Columns.Add(MakeColumn("TransportGroupMaxProgress", "TransportGroupMaxProgress", GetType(Integer), , , , , , , True))
        ...
        t.Columns.Add(MakeColumn("Manpad", "Manpad", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("Beartrap", "Beartrap", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("Camera", "Camera", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("Waterdrum", "Waterdrum", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("BloodcatMeat", "BloodcatMeat", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("CowMeat", "CowMeat", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("Beltfed", "Beltfed", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("Ammobelt", "Ammobelt", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("AmmobeltVest", "AmmobeltVest", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("CamoRemoval", "CamoRemoval", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("Cleaningkit", "Cleaningkit", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("AttentionItem", "AttentionItem", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("Garotte", "Garotte", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("Covert", "Covert", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("Corpse", "Corpse", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("BloodcatSkin", "BloodcatSkin", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("NoMetalDetection", "NoMetalDetection", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("JumpGrenade", "JumpGrenade", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("Handcuffs", "Handcuffs", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("Taser", "Taser", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("ScubaBottle", "ScubaBottle", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("ScubaMask", "ScubaMask", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("ScubaFins", "ScubaFins", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("TripwireRoll", "TripwireRoll", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("Radioset", "Radioset", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("SignalShell", "SignalShell", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("Soda", "Soda", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("RoofcollapseItem", "RoofcollapseItem", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("DiseaseprotectionFace", "DiseaseprotectionFace", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("DiseaseprotectionHand", "DiseaseprotectionHand", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("LBEexplosionproof", "LBEexplosionproof", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("EmptyBloodbag", "EmptyBloodbag", GetType(Boolean), 0, , , , , , True))
        ...
        t.Columns.Add(MakeColumn("AntitankMine", "AntitankMine", GetType(Boolean), , , , , , , True))
        ...
        t.Columns.Add(MakeColumn("DiseaseSystemExclusive", "DiseaseSystemExclusive", GetType(Boolean), , , , , , , True))
        ...
        t.Columns.Add(MakeColumn("AllowClimbing", "Allow Climbing", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("Cigarette", "Cigarette", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("ProvidesRobotCamo", "ProvidesRobotCamo", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("ProvidesRobotNightVision", "ProvidesRobotNightVision", GetType(Boolean), 0, , , , , , True))
        t.Columns.Add(MakeColumn("ProvidesRobotLaserBonus", "ProvidesRobotLaserBonus", GetType(Boolean), 0, , , , , , True))
        'End of ItemFlags
        ...
        t.Columns.Add(MakeColumn("PercentAim1", "Standing Percent Aim Bonus", GetType(Integer), -101, , , , , , True))
        ...
        t.Columns.Add(MakeColumn("PercentAim2", "Standing Percent Aim Bonus", GetType(Integer), -101, , , , , , True))
        ...
        t.Columns.Add(MakeColumn("PercentAim3", "Standing Percent Aim Bonus", GetType(Integer), -101, , , , , , True))
